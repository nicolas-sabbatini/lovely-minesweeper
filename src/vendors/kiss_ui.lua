...
---@field calculate_layout fun(self: ui_tree, mouse_x: number, mouse_y: number, root_x: number?, root_y: number?)
...
local function calculate_layout(self, mouse_x, mouse_y, root_x, root_y)
	...
	if self.root then
		...
		calculate_positions(self.root, root_x or 0, root_y or 0, mouse_x, mouse_y)
	end
end
